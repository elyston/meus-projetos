...
public class gerente implements login  {
    ...
    /**
     * este método exibe os clientes cadastrados, apenas o gerente visualizará a lista
     * @param cl
     * @param cont 
     */
...
//    }
    /**
     * o método solicita que o gerente informe ao usuário o valor que poderá pagar segundo o preço em tabela e também as formas de pagamento, o usuário irá receber um comprovante para recebimento do veículo na concessionária  
     * @param cl
     * @param valor
     * @param taxa 
     */
